...
import { Button, Heading, Container, Stack, Text, VStack } from '@chakra-ui/react';
...
const Videos = () => {
  ...
  <Stack direction={['column', 'row']} >
    ...
    <VStack w={['full','xl']} alignItems={'stretch'} p={'8'} spacing={'8'} overflowY={'auto'}>
        ...
        <Button variant={'solid'} colorScheme={'purple'} onClick={()=> setVideoSrc(item)}>Lecture {index + 1}</Button>
        ))}
    </VStack>
  </Stack>
  );
